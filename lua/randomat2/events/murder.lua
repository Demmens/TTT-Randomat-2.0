	...
	timer.Create("RandomatMurderTimer", 0.1, 0, function()
		for k, v in pairs(self.GetAlivePlayers(true)) do
			for _, wep in pairs(v:GetWeapons()) do
				if wep.Kind == WEAPON_HEAVY or wep.Kind == WEAPON_PISTOL or wep.Kind == WEAPON_NADE or wep.ClassName == "weapon_zm_improvised" or wep.ClassName == "weapon_ttt2_jes_improvised" then
